    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          status: 'Website ini untuk kelas saya, saya buat website seperti ini biar kelas saya lebih bagus.',
          tech: 'VueJS 3, Tailwind',
          github: 'https://github.com/ndraaganz/kelas.github.io',
          demo: 'https://kelasxe2.vercel.app/#'
        }
      ]
    };
  }
